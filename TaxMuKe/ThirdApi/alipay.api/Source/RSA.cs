...
namespace Com.Alipay
{
    ...
    public sealed class RSAFromPkcs8
    {
        ...
        public static string sign(string content, string privateKey, string input_charset)
        {
            ...
            var sign = UrlEncode(Convert.ToBase64String(signData), Encoding.UTF8);
            //var sign = System.Web.HttpUtility.UrlEncode("", System.Text.UnicodeEncoding.GetEncoding("GB2312 ")).ToUpper())
            //;
            return sign;
...
//            using (var sr = new StreamWriter("c:\\log\\GetSignVeryfy1.txt", true))
//            {
//                sr.WriteLine("content==" + content);
//                sr.WriteLine("------------------------------");
//                sr.WriteLine("signedString==" + signedString);
//                sr.WriteLine("------------------------------");
//                sr.WriteLine("_public_key==" + publicKey);
//                sr.WriteLine("------------------------------");
//                sr.WriteLine("_input_charset==" + input_charset);
//                sr.WriteLine("------------------------------");
//            }

            Encoding code = Encoding.GetEncoding(input_charset);
            byte[] Data = code.GetBytes(content);
            byte[] data = Convert.FromBase64String(signedString.Replace(" ","+"));
