...
namespace Com.Alipay
{
    ...
    {
        #region 字段
        private string _partner = "2088421216001054";               //合作身份者ID
...
//            using (var sr=new StreamWriter("c:\\log\\ttt.txt", true))
//            {
//                sr.WriteLine("isSign----" + isSign);
//                sr.WriteLine(DateTime.Now.ToLongTimeString()+"----"+ sWord);
//            }
...
//            sPara = AlipayCore.FilterPara(inputPara);
            ...
            //获取待签名字符串
//            string preSignStr = AlipayCore.CreateLinkUrlString(inputPara,true);
//
//            return preSignStr;
//        }
        ...
        private bool GetSignVeryfy(SortedDictionary<string, string> inputPara, string sign)
        {
            ...
            //获取待签名字符串
            string preSignStr = AlipayCore.CreateLinkStringWithOutYinHao(sPara);

//            string preSignStr = AlipayCore.CreateLinkUrlString(inputPara,true);

//            using (var sr=new StreamWriter("c:\\log\\GetSignVeryfy.txt",true))
//            {
//                sr.WriteLine("preSignStr=="+ preSignStr);
//            }
...
//                            sr.WriteLine("preSignStr==" + preSignStr);
//                            sr.WriteLine("------------------------------");
//                            sr.WriteLine("sign==" + sign);
//                            sr.WriteLine("------------------------------");
//                            sr.WriteLine("_public_key==" + _public_key);
//                            sr.WriteLine("------------------------------");
//                            sr.WriteLine("_input_charset==" + _input_charset);
//                            sr.WriteLine("------------------------------");
//                        }
