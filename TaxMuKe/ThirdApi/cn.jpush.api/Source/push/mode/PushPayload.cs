    ...
    public class PushPayload
    {
        ...
        */
        ...
        public bool IsGlobalExceedLength()
        {
            ...
            if (message!= null)
            {
               var messageJson = JsonConvert.SerializeObject(this.message, Formatting.None, jSetting);
        ...
        public bool IsIosExceedLength()
        {
            if (this.notification != null)
            {
                ...
                {
                    var iosJson = JsonConvert.SerializeObject(this.notification.IosNotification, Formatting.None, jSetting);
                    if (iosJson != null)
                    {
