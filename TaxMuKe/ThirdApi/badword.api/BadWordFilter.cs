...
namespace ThirdApi.badword.api
{
    ...
    {
        public FilterWord(string[] dirtyWords)
        {
            this.mDictyWords = dirtyWords;
        }

        public FilterWord() { }
        

        private string[] mDictyWords=new []{String.Empty, };
        
        public string[] DictyWords
        {
            get { return mDictyWords; }
            set { mDictyWords = value; }
        }
        ...
        private bool Check(string blackWord)
        {
            ...
            for (int i = 0; i < blackWord.Length; i++)
            {
                ...
                else
                {
                    ...
                    if (sourctText.Length > nextCursor + offset)
                    {
