...
{
    public class MuKeAboutUsController:Controller
    {
        public ActionResult Index()
        {
            var set =
                SessionContext.Repository.MuKeGlobalSets.FirstOrDefault(x => x.GlobalSetType == GlobalSetType.AboutUs);
            if (set == null)
            {
        ...
        public ActionResult Save(string Content)
        {
            ...
            {
                set=new MuKeGlobalSet();
                set.GlobalSetType = GlobalSetType.AboutUs;
                set.Content = Content;
